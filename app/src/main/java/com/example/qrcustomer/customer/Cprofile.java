                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            Intent a = new Intent(Cprofile.this, Cprofile.class);
                            startActivity(a);

                        }

                        if (drawerItem.getIdentifier() == 2) {
                            Intent b = new Intent(Cprofile.this, Store.class);
                            startActivity(b);
                        ...
                        if (drawerItem.getIdentifier() == 3) {
                            ...
                            Intent c = new Intent(Cprofile.this, Terms.class);
                            startActivity(c);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 5) {
                            ...
                            Intent e = new Intent(Cprofile.this, Ask.class);
                            startActivity(e);
                        }

                        if (drawerItem.getIdentifier() == 6) {

                            Intent e = new Intent(Cprofile.this, Support.class);
                            startActivity(e);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 7) {
                            ...
                            Intent f = new Intent(Cprofile.this, Sign.class);
                            startActivity(f);
                            finish();
                        }
